...
class RentalApp(ctk.CTk):
    def __init__(self):
        ...
        self.shopping_image = ctk.CTkImage(light_image=Image.open("C:\\Users\\manas\\Documents\\rental\\photos\\shopping.png"), size=(20, 20))
        self.shopping_hover_image = ctk.CTkImage(light_image=Image.open("C:\\Users\\manas\\Documents\\rental\\photos\\shopping1.png"), size=(20, 20))
        self.manage_image = ctk.CTkImage(light_image=Image.open("C:\\Users\\manas\\Documents\\rental\\photos\\manage.png"), size=(20, 20))
        self.manage_hover_image = ctk.CTkImage(light_image=Image.open("C:\\Users\\manas\\Documents\\rental\\photos\\manage1.png"), size=(20, 20))
